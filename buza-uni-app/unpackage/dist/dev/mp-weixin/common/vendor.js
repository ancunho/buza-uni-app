...
function populateParameters(result) {var _result$brand =
  ...
  var parameters = {
    appId: "__UNI__B16F152",
    appName: "buza-uni-app",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function getPostDetailByPostId(params) {
  return new Promise(function (resolve, reject) {
    _request.default.post("/miniapp/api/getPostDetailByPostId.do", params).then(function (result) {
      resolve(result);
    }).catch(function (error) {
      reject(error);
    });
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  app_web_url: 'http://localhost:8001/manage', // h5域名PC域名，用于分享图片或者拼接图片时使用，结尾必须加 “/”
  // app_web_url: 'https://www.cunho.online/manage', // h5域名PC域名，用于分享图片或者拼接图片时使用，结尾必须加 “/”
  app_web_api_url: 'http://localhost:8001/manage',
  // app_web_api_url: 'https://www.cunho.online/manage',
...
/***/ 57:
/*!**********************************************************************************************************!*\
  !*** D:/project/buza-uni-app/buza-uni-app/buza-uni-app/uni_modules/mp-html/components/mp-html/parser.js ***!
  \**********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
